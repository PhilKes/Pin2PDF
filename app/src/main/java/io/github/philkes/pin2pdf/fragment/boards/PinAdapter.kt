...
import io.github.philkes.pin2pdf.BuildConfig
...
/*
        private fun openPdfFile(url: String) {
            ...
            val pdfIntent = Intent(Intent.ACTION_VIEW, Uri.parse("https://docs.google.com/gview?embedded=true&url=file://data/data/io.github.philkes.pin2pdf/files/817684876070151523.pdf"))
