...
public class MockData {
    public static List<PinModel> MockPins=new ArrayList<>(Arrays.asList(
            new PinModel(-1,"" ,
                    ...
                    "https://holabys.com/2020/08/14/honig-balsamico-knoblauch-pilze/", null, "Test", null),
            new PinModel(-1,"" ,
            ...
            new PinModel(-1,"" ,
                    ...
                    "https://www.freundin.de/kochen-diaet-kartoffel-zucchini-puffer?utm_medium=social&utm_campaign=Sharing&utm_source=Sharing_Pinterest", null, "Test", null)
    ));
}
